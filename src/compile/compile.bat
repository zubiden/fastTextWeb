...
emcc --bind -o ../fasttext-wasm.js args.cc matrix.cc dictionary.cc loss.cc productquantizer.cc densematrix.cc quantmatrix.cc vector.cc model.cc utils.cc meter.cc fasttext.cc main.cc -s NO_EXIT_RUNTIME -s MODULARIZE=1 -s NO_DYNAMIC_EXECUTION=1 -s EXPORT_NAME='fasttextmodule' --embed-file lid.176.ftz -std=c++11 -O2